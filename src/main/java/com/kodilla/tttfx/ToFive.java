...
public class ToFive extends MainBrain {
    public ToFive(boolean vsComputer) {
    ...
    public void start(Stage primaryStage) {
        ...
        primaryStage.setTitle("Tic Tac Toe - ToFive");
        primaryStage.show();
    }
